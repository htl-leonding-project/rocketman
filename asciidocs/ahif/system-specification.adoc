...
rectangle Rocketman {
    ...
    rectangle {
        (initiate the ignition of the rocket)
        (control actuator)
        (communicate wirelessly with branch offices)
        (set software mode of operation)
    }
    rectangle {
        ...
        (activate actuator)
        (set countdown)
        (configure system) .right.> (activate actuator)
        (configure system) .left.> (set countdown)
    }
}
ReadOnlyUser -- (receive telemetry data)
User -->> ReadOnlyUser
User -- (initiate the ignition of the rocket)
User -- (control actuator)
User -- (set software mode of operation)
User -- (communicate wirelessly with branch offices)
Admin -->> User
