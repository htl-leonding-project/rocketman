= Rocketman
Feichtinger Sarah, Dumfarth Felix, Lukas Hain, Jan Kaufmann
1.1.0, 2020-10-28
...
|1a
a| JSON Objekte sollten über LoRa als Plain Text gesendet werden.
...
|3
a| Es werden ein JSON Array von allen Starts und eines von allen DataSets zusmmen in einem JSON Object mittels MQTT übermittelt
...
|6
a| Die einzelnen Bilder werden als base64 String übergeben
...
* https://youtu.be/-oZP3VJ7W_c?t=3720[Project Award 5AHIF]

* https://youtu.be/ynMgZQklOlo?t=11691[Project Award 5AHITM]

* https://github.com/htl-leonding-project/rocketman[GitHub Repository]

* https://vm81.htl-leonding.ac.at/agiles/99-269/current[YouTrack]
...
* https://htl-leonding-project.github.io/rocketman/protokoll_290322_Koffer_setup[Protokoll Koffer Setup, 29.03.2022]
